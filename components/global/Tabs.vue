<script setup>
const { items, reverseRadius } = defineProps({ items: Array, reverseRadius: Boolean })

const currentTab = ref(0)

</script>
<template>
    <div :class="{ 'tabs--reverse-radius': reverseRadius }" class="tabs">
        ...
        <div class="tabs__body">
            <div :data-title="item.title" :class="{ 'tabs__paragraphs--active': items[currentTab] == item }"
                v-for="(item, index) in items" :key="index" class="tabs__paragraphs">
